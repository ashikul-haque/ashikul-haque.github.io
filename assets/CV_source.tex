...
\entry{\textbf{Wireless and SDR:}}{GNU Radio, USRP B200, LoRa and LR-FHSS physical layers, LoRaWAN, COTS LoRa nodes and gateways, Tmote Sky}
\entry{\textbf{Learning and simulation:}}{PyTorch, Pandas, NS-3, CARLA, vLLM}
\entry{\textbf{Systems and tools:}}{Linux, Docker, Git, LaTeX}
